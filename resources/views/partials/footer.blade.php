    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-sm-12">
                ...
                <p class="dummy_text">Lorem ipsum dolor sit amet, consectetur adipiscing elit...</p>
            </div>
            <div class="col-lg-3 col-sm-6">
                <div class="information_main">
                    <h4 class="information_text">Useful Links</h4>
                    <p class="many_text">Contrary to popular belief, Lorem Ipsum is not simply random text.</p>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6">
                <div class="information_main">
