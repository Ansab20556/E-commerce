...
@section('content')
    ...
    <div class="banner_section layout_padding">
        <div id="my_slider" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-item active">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div><img src="{{ asset('images/img-1.png') }}" class="image_1"></div>
                            </div>
                        </div>
            ...
            <a class="carousel-control-prev" href="#my_slider" role="button" data-slide="prev">
                <i><img src="{{ asset('images/left-icon.png') }}"></i>
            </a>
            <a class="carousel-control-next" href="#my_slider" role="button" data-slide="next">
                <i><img src="{{ asset('images/right-icon.png') }}"></i>
            </a>
        </div>
    </div>
    <!--banner section end -->
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12">
                    <div class="beauty_box">
                        ...
                        <div><img src="{{ asset('images/img-5.png') }}" class="image_3"></div>
                        <div class="seemore_bt"><a href="#">see More</a></div>
                    </div>
                </div>
                <div class="col-lg-8 col-sm-12">
                    <div class="beauty_box_1">
                        ...
                        <div><img src="{{ asset('images/img-6.png') }}" class="image_3"></div>
    ...
    <div class="product_section layout_padding">
        <div class="container">
            ...
            <p class="feature_text">It is a long established fact that a reader will be distracted by the readable content...</p>
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <div class="container">
                        ...
                        <p class="feature_text">It is a long established fact that a reader will be distracted...</p>
                        <div class="client_section_2">
                            <div class="image_9"><img src="{{ asset('images/img-9.png') }}"></div>
                            <h3 class="nolmal_text">Normal distribution</h3>
                            <p class="ipsum_text">It is a long established fact that a reader will be distracted by the readable content...</p>
                            <div class="image_9"><img src="{{ asset('images/icon-10.png') }}"></div>
                        </div>
                    </div>
                </div>
                <!-- Client Slide 2 -->
                <div class="carousel-item">
                    <div class="container">
                        ...
                        <div class="client_section_2">
                            <div class="image_9"><img src="{{ asset('images/img-9.png') }}"></div>
                            <h3 class="nolmal_text">Normal distribution</h3>
                            <p class="ipsum_text">It is a long established fact that a reader will be distracted...</p>
                            <div class="image_9"><img src="{{ asset('images/icon-10.png') }}"></div>
                        </div>
                    </div>
                </div>
    ...
    <div class="newsletter_section layout_padding">
        <div class="container">
            ...
            <p class="newsletter_text">There are many variations of passages of Lorem Ipsum available...</p>
